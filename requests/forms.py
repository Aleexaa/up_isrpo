...
class RequestForm(forms.ModelForm):
    class Meta:
        model = Request
        fields = ['homeTechType', 'homeTechModel', 'problemDescryption', 
                  'client', 'master', 'requestStatus', 'completionDate']  
        widgets = {
            ...
            'requestStatus': forms.Select(attrs={'class': 'form-control'}),  
            'completionDate': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),  
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['requestStatus'].label = 'Статус заявки'
        self.fields['completionDate'].label = 'Дата завершения'  
        self.fields['completionDate'].required = False  
